...
public class PeerDiscovery
{
  ...
  public static void main( String[] args )
  {
    ...
    try
    {
      ...
      PeerDiscovery mp = new PeerDiscovery( group, 2269 );
        ...
        {  System.out.println( "Querying" );
          ...
          for( Peer p : peers )
          {
            System.out.println( "\t" + p );
              ...
              System.out.println("Select a peer using index//starts from 0");
              String str1 = br.readLine();
              int k =Integer.parseInt(str1);
              System.out.println("k is:"+k);
              System.out.println("SElected peer is"+peers[k]);
              String p = peers[k].ip.getHostAddress();
              System.out.println(p);
              Musicfiles musicfile = new Musicfiles(p);
              str="false";
              stop=true;
              ...
              System.out.println("0 peers found,trying again");
          }
        }
